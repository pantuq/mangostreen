...
![[Pasted image 20231209162000.png]]
...
配置eslintrc.cjs解决声明未使用警告
![[Pasted image 20230425193402.png]]
```
rules: {
...
  }
```
如果启用vetur组件会在组件导入时报错，但不影响编译
![[Pasted image 20230425194046.png]] 
![[Pasted image 20230425193951.png]]
